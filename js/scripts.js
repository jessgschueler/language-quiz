...
//     if (result >= 36 && result !== 40) {
//       $("form").addClass(".swiftpage")
//     } else if (result >= 15 && result <= 35 && result !== 24 || result === 40) {
//       $("form").addClass(".javapage")
//      } else if (result <= 14 || result === 24) {
//       $("form").addClass(".pythonpage")
//     } else {
//       alert("uh-oh! please fill out all options!")
//     }
//   });
// });
